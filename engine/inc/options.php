...
HTML;
	...
	while ( $row = $db->get_array() ) {
		...
		$row['descr'] = strip_tags(stripslashes($row['descr']));
			...
			$sections .= <<<HTML
	  <div class="col-md-6 media-list media-list-linked">
...
HTML;
	...
	showRow( $lang['opt_sys_hu'], $lang['opt_sys_hud'], "<input type=\"text\" class=\"form-control\" name=\"save_con[http_home_url]\" value=\"{$config['http_home_url']}\">" );
...
HTML;
	...
	showRow( $lang['opt_sys_ct'], "<a onClick=\"javascript:Help('date')\" href=\"#\">$lang[opt_sys_and]</a>", "<input  type=\"text\" class=\"form-control\" style=\"max-width:150px; text-align: center;\" name='save_con[timestamp_comment]' value=\"{$config['timestamp_comment']}\">" );
...
HTML;
	...
	showRow( $lang['opt_sys_maxside'], $lang['opt_sys_maxsided'], "<input  type=\"text\" class=\"form-control\" style=\"max-width:150px; text-align: center;\"  name='save_con[max_up_side]' value=\"{$config['max_up_side']}\" >", "white-line" );
