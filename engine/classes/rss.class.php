...
class xmlParser {
	...
	function convert() {
		...
		if( $to == $this->rss_charset OR !$this->rss_charset) return;
		...
		if( function_exists( 'mb_convert_encoding' ) ) {
			...
			foreach ( $this->content as $content ) {
				...
				if( $this->content[$i]['title'] ) $this->content[$i]['title'] = mb_convert_encoding( $this->content[$i]['title'], $to, $this->rss_charset );
				
				if( $this->content[$i]['description'] ) $this->content[$i]['description'] = mb_convert_encoding($this->content[$i]['description'], $to, $this->rss_charset );
				
				if( $this->content[$i]['content'] ) $this->content[$i]['content'] = mb_convert_encoding($this->content[$i]['content'], $to, $this->rss_charset );
				
				if( $this->content[$i]['category'] ) $this->content[$i]['category'] = mb_convert_encoding($this->content[$i]['category'], $to, $this->rss_charset );
				
				if( $this->content[$i]['author'] ) $this->content[$i]['author'] = mb_convert_encoding($this->content[$i]['author'], $to, $this->rss_charset );
			...
			foreach ( $this->content as $content ) {
				...
				$this->content[$i]['title'] = iconv( $this->rss_charset, $to . "//IGNORE", $this->content[$i]['title'] );
				
				$this->content[$i]['description'] = iconv( $this->rss_charset, $to . "//IGNORE", $this->content[$i]['description'] );
				
				if( $this->content[$i]['content'] ) $this->content[$i]['content'] = iconv( $this->rss_charset, $to . "//IGNORE", $this->content[$i]['content'] );
				
				if( $this->content[$i]['category'] ) $this->content[$i]['category'] = iconv( $this->rss_charset, $to . "//IGNORE", $this->content[$i]['category'] );
				
				if( $this->content[$i]['author'] ) $this->content[$i]['author'] = iconv( $this->rss_charset, $to . "//IGNORE", $this->content[$i]['author'] );
