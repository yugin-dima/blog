...
if ($_POST['action'] == "pm") {
	...
	$db->query( "INSERT INTO " . PREFIX . "_complaint (`p_id`, `c_id`, `n_id`, `text`, `from`, `to`, `date`) values ('0', '{$row['id']}', '0', '{$text}', '{$author}', '', '{$_TIME}')" );
	...
	$db->query( "INSERT INTO " . PREFIX . "_complaint (`p_id`, `c_id`, `n_id`, `text`, `from`, `to`, `date`) values ('0', '0', '{$row['id']}', '{$text}', '{$author}', '', '{$_TIME}')" );
